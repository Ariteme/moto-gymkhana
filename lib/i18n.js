...
export const i18n = {
  en: {
    ...
    participant_number_placeholder: 'Your racing number (e.g. 33)',
  ...
  ru: {
    ...
    map_btn: '🗺 Карта',
    podium_btn: '🏆 Подиум',
    facebook_group: '👥 Группа Facebook',

    // Submit
    submit_title: 'Отправить заезд',
    rider_name: 'Имя гонщика',
    rider_name_placeholder: 'Ваше имя на английском',
    participant_number: 'Участник #',
    participant_number_placeholder: 'Ваш гоночный номер (например 33)',
